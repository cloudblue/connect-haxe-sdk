...
class UsageFile extends IdModel {
    ...
    **/
    ...
    private static function zipSheet(name: String, sheet: Sheet): Bytes {
        ...
        entries.add(zipEntry('xl/_rels/workbook.xml.rels', RELS));
